    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
            <div className="max-w-md w-full bg-gray-50 p-8 rounded-lg shadow-md">
                ...
                />
                <h1 className="text-4xl font-semibold mb-6 text-left text-black">Connectez-vous</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className={`text-white w-full py-2 rounded-3xl font-semibold ${loading ? "bg-indigo-800 cursor-not-allowed" : "bg-indigo-800 hover:bg-blue-700"
                            }`}
                    >
                ...
                <p className="text-black mt-2">Vous n'avez pas de compte ? <Link
